...
Program::Program()
{
	...
	Programs[2][0] = WashCycle(Fill,	7,	Off); 
	Programs[2][1] = WashCycle(Heat,	4,	Off); 
	Programs[2][2] = WashCycle(Wash,	6,	Low); 
	Programs[2][3] = WashCycle(Empty,	3,	Off); 
	Programs[2][4] = WashCycle(Fill,	5,	Off); 
	Programs[2][5] = WashCycle(Rinse,	7,	Low); 
	Programs[2][6] = WashCycle(Empty,	3,	Off); 
	Programs[2][7] = WashCycle(Spin,	6,	High); 
	Programs[2][8] = WashCycle(Dry,	5,	Off); 
	Programs[2][9] = WashCycle(Complete,	0,	Off); 
	Programs[3][0] = WashCycle(Fill,	7,	Off); 
	Programs[3][1] = WashCycle(Heat,	4,	Off); 
	Programs[3][2] = WashCycle(Wash,	6,	Low); 
	Programs[3][3] = WashCycle(Empty,	3,	Off); 
	Programs[3][4] = WashCycle(Dry,	5,	Off); 
	Programs[3][5] = WashCycle(Complete,	0,	Off); 
	Programs[4][0] = WashCycle(Fill,	10,	Off); 
	Programs[4][1] = WashCycle(Spin,	5,	High); 
	Programs[4][2] = WashCycle(Empty,	10,	Off);
	Programs[4][3] = WashCycle(Spin,	5,	High);
	Programs[4][4] = WashCycle(Empty,	10,	Off);
	Programs[4][5] = WashCycle(Complete,	0,	Off); 
}
